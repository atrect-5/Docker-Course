...
**Avances Realizados:**
1.  **`.dockerignore`**: Se ha añadido un archivo `.dockerignore`, que sirve para excluir ficheros no necesarios (como por ejemplo `node_modules`) del contexto de construcción, optimizando así el tamaño y la seguridad de la imagen.
